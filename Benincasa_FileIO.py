...
Imports: matplotlib for graphing purposes
    csv for data reading and editing purpsoes
...
def main():
    ...
    file_input = open("C:/Users/kbenincasa26/Documents/CS/gcds_data2.csv")
...
def add_data(file_input):
    ...
    # Step 4: Using csv.writer to write the list to the CSV file
        ...
        writer.writerow(new_data) # Use writerow for single list
    print("New Record Added.")
    file.close

def delete_data(file_input):
    '''
    1. What name is to be deleted?
    2. Make a list
    3. Iterate through the file
        a. check if its the name
            i. if it is continue
            ii. if it's not then append the row to the list
    4. Overite the file and add each item of the list to it
    '''
    file_input.seek(1)
